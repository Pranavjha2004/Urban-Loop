...
//   /* ✅ FIXED LINE */
//   const isOwnProfile = loggedUser && loggedUser._id === profileId;
...
//                 {/* MESSAGE BUTTON */}
//                     {loggedUser && user && loggedUser._id !== user._id && (
//                       <button
...
function Profile() {
  ...
  /* ✅ FIXED LINE (Mongo ID safe comparison) */
  const isOwnProfile =
    loggedUser && profileId && loggedUser._id.toString() === profileId.toString();
